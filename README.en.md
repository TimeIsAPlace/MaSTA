...
The [live listening demo](https://timeisaplace.github.io/MaSTA/) contains 20 groups and 60 audio files, playable directly in your browser without installing a model. For a local preview, run `python -m http.server 8000 --bind 127.0.0.1` from this repository root, then visit <http://localhost:8000/demo_page/>.
