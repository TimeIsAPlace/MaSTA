...
> Retained upstream example, outside MaSTA's supported stutter workflow.
> Results below describe the upstream experiment and have not been reproduced
> or claimed as MaSTA results. This recipe needs its own environment.
...
| CosyVoice2 LLM + GRPO | 1.37% | **3.36%** | Upstream model identifier: `yuekai/official-cosyvoice-llm-grpo-aishell3` (Hugging Face format; availability not verified) |
